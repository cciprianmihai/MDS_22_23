    ...
    class Program
    {
        ...
        public static void UseModelWithBatchItems(MLContext mlContext, ITransformer model)
        {
            ...
            IEnumerable<SentimentData> sentiments = new[]
            {
                ...
                new SentimentData
                {
                    SentimentText = "Amazing university, we like it."
                },
                new SentimentData
                {
                    SentimentText = "I am concerned about the bad news of the accident."
                },
                new SentimentData
                {
                    SentimentText = "This machine learning model works good. I am happy!"
                }
            };
            // </SnippetCreateTestIssues>
